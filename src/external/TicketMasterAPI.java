...
public class TicketMasterAPI {
	...
	private static final String API_KEY = new Config().getKey();
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			// Initiate HTTP request --> open connection and send request
			...
			// Get response string --> the content we want 
			// try with resources --> after finished auto close in
