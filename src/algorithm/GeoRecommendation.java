		...
		try {
			...
			Collections.sort(categoryList, new Comparator<Entry<String, Integer>>(){
				...
				public int compare(Entry<String, Integer> o1, Entry<String, Integer> o2) {
					// descending order --> o2 before o1
					return Integer.compare(o2.getValue(), o1.getValue());
				}
			});
			
			// Step 3 do search based on category, filter out favorite events, sort by distance
			// some events may have different categories, so we might get the same event from
			// different category --> use this "visitedItems" map to avoid this
